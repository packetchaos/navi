...
def tone_findings_export(ex_uuid, threads):
    ...
    raw_prop_list = ("asset_id, finding_id, state, last_updated, first_observed_at, last_observed_at, last_fixed_at, "
                     "port, protocol, cpes, finding_parent_detection_id, finding_detection_id, finding_provider_code, "
                     "finding_product_code, finding_provider_detection_id, finding_detection_code, "
                     "finding_detection_version, finding_detection_variant, finding_detection_sub_category, "
                     "finding_resource_type, finding_detection_family, finding_detection_type, finding_intel_type, "
                     "finding_name, finding_synopsis, finding_description, finding_solution, finding_script_file_name, "
                     "finding_exploit_maturity, finding_detection_published_at, finding_vuln_published_at, "
                     "finding_patch_published_at, finding_first_covered_at, finding_first_functional_exploit_at, "
                     "finding_first_poc_at, finding_cisa_kev_added_date, finding_cisa_kev_due_date, "
                     "finding_epss_scored_at, finding_severity_driver, finding_severity, finding_severity_level, "
                     "finding_risk_factor, finding_risk_severity_level, finding_vpr_score, finding_vpr2_score, "
                     "finding_vpr_risk_factor, finding_vpr_severity_level, finding_exploitability_ease_code, "
                     "finding_exploitability_ease, finding_cvss2_source, finding_cvss2_base_score, "
                     "finding_cvss2_base_vector, finding_cvss2_temporal_score, finding_cvss2_temporal_vector, "
                     "finding_cvss3_source, finding_cvss3_base_score, finding_cvss3_base_vector, "
                     "finding_cvss3_temporal_score, finding_cvss3_temporal_vector, finding_cvss4_source, "
                     "finding_cvss4_score, finding_cvss4_vector, finding_cvss4_threat_metrics, finding_epss_score, "
                     "finding_epss_percentile, finding_stig_severity, finding_is_security_control, "
                     "finding_is_deprecated, finding_cves, finding_cwes, finding_metadata_file_name, "
                     "asset_name, asset_class, acr, aes, is_licensed, total_finding_count, fixed_finding_count, "
                     "sensor_type")
